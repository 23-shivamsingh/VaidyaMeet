...
const AppointmentCard = ({ appointment, userRole }) => {
  ...
  return (
    <>
      <Card className="border-indigo-900/20 hover:border-indigo-700/30 transition-all">
            ...
            <div className="flex flex-col gap-2 self-end md:self-start">
              <Badge
                ...
                className={
                  appointment.status === "COMPLETED"
                    ? "bg-indigo-900/20 border-indigo-900/30 text-indigo-400 self-start"
              ...
              <div className="flex gap-2 mt-2 flex-wrap">
                ...
                <Button
                  size="sm"
                  variant="outline"
                  className="border-indigo-900/3 cursor-pointer"
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center">
                <div className="h-5 w-5 text-indigo-400 mr-2">
                  {otherPartyIcon}
                </div>
                <div>
            ...
            <div className="space-y-2">
              ...
              <Badge
                ...
                className={
                  appointment.status === "COMPLETED"
                    ? "bg-indigo-900/20 border-indigo-900/30 text-indigo-400"
                    : appointment.status === "CANCELLED"
            ...
            {appointment.patientDescription && (
              <div className="space-y-2">
                ...
                <div className="p-3 rounded-md bg-muted/20 border border-indigo-900/20">
            ...
            {appointment.status === "SCHEDULED" && (
              <div className="space-y-2">
                ...
                <Button
                  className="w-full bg-indigo-600 hover:bg-indigo-700 cursor-pointer text-white"
                  disabled={
                ...
                {userRole === "DOCTOR" &&
                  ...
                  appointment.status !== "CANCELLED" && (
                    <Button
                      ...
                      className="h-7 text-indigo-400 hover:text-indigo-300 hover:bg-indigo-900/20"
                    >
              ...
              {userRole === "DOCTOR" && action === "notes" ? (
                <div className="space-y-3">
                  <Textarea
                    ...
                    className="bg-background border-indigo-900/20 min-h-[100px]"
                  />
                ...
                <div className="p-3 rounded-md bg-muted/20 border border-indigo-900/20 min-h-[80px]">
                  {appointment.notes ? (
                    <p className="text-white whitespace-pre-line">
                      {appointment.notes}
                    </p>
