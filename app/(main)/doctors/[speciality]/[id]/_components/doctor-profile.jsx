          ...
          <Card className="border-indigo-900/20">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                <div className="relative w-32 h-32 rounded-full overflow-hidden mb-4 bg-indigo-900/20">
                  {doctor.imageUrl ? (
                    <Image
                      src={doctor.imageUrl}
                      alt={doctor.name}
                ...
                <Badge
                  variant="outline"
                  className="bg-indigo-900/20 border-indigo-900/30 text-indigo-400 mb-4"
                >
                  {doctor.specialty}
                </Badge>

                <div className="flex items-center justify-center mb-2">
                  <Medal className="h-4 w-4 text-indigo-400 mr-2" />
                ...
                <Button
                  ...
                  className="w-full bg-indigo-600 hover:bg-indigo-700 mt-4 cursor-pointer text-white"
                >
                  {showBooking ? (
                    <>
                      Hide Booking
