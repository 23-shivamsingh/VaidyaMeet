...
import { Loader2, ArrowLeft, Clock, Calendar, CreditCard } from "lucide-react";
    ...
    <form className="space-y-6" onSubmit={handleSubmit}>
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          className="bg-background border-indigo-900/20 h-32"
        />
      ...
      <div className="flex justify-between pt-2">
        <Button
          ...
          onClick={onBack}
          disabled={loading}
          className="border-indigo-900/30 cursor-pointer"
        >
