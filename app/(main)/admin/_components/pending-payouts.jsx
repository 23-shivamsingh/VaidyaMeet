...
export function PendingPayouts({ payouts }) {
  ...
  return (
    <div>
      <Card className="bg-muted/20 border-indigo-900/20">
        <CardHeader>
          ...
          {payouts.length === 0 ? (
            ...
            <div className="space-y-4">
              {payouts.map((payout) => (
                <Card
                  key={payout.id}
                  className="bg-background border-indigo-900/20 hover:border-indigo-700/30 transition-all"
                >
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap items-center gap-4 mt-2 text-sm text-muted-foreground">
                            <div className="flex items-center">
                              <DollarSign className="h-4 w-4 mr-1 text-indigo-400" />
                              <span>
                      ...
                      <div className="flex flex-col sm:flex-row gap-2 self-end lg:self-center">
                        ...
                        <div className="flex gap-2">
                          <Button
                            ...
                            className="border-indigo-900/30 hover:bg-muted/80"
                          >
                            View Details
                          </Button>
                          <Button
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-muted/20 p-4 rounded-lg border border-indigo-900/20 space-y-3">
                  ...
                  <div className="border-t border-indigo-900/20 pt-3 flex justify-between font-medium">
                    <span className="text-white">Net payout:</span>
                    <span className="text-indigo-400">
                      ${selectedPayout.netAmount.toFixed(2)}
                    </span>
                  </div>
                  <div className="border-t border-indigo-900/20 pt-3">
                    <p className="text-sm font-medium text-muted-foreground">
                      PayPal Email
                    </p>
        ...
        >
          <DialogContent>
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="bg-muted/20 p-4 rounded-lg border border-indigo-900/20">
