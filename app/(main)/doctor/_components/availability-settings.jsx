...
const AvailabilitySettings = ({ slots }) => {
  ...
  return (
    <Card className="border-indigo-900/20">
      <CardHeader>
      ...
      <CardContent>
        {!showForm ? (
                ...
                <div>
                  {slots.map((slot) => {
                    return (
                      <div
                        key={slot.id}
                        className="flex items-center p-3 rounded-md bg-muted/20 border border-indigo-900/20"
                      >
                        <div className="bg-indigo-900/20 p-2 rounded-full mr-3">
          ...
          <form
            className="space-y-4 border border-indigo-900/20 rounded-md p-4"
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-background border-indigo-900/20"
                />
                {errors.startTime && (
            ...
            <div className="flex justify-end space-x-3 pt-2">
              <Button
                ...
                disabled={loading}
                className="border-indigo-900/30 text-white"
              >
                Cancel
              </Button>
              <Button
        ...
        <div className="mt-6 p-4 bg-muted/10 border border-indigo-900/10 rounded-md">
