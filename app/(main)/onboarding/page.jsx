...
// Define the schema for doctor form validation using Zod
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card
          ...
          className="border-indigo-900/20 hover:border-indigo-700/40 cursor-pointer transition-all"
        >
          <CardContent className="pt-6 pb-6 flex flex-col items-center text-center">
            ...
            <CardDescription className="mb-4">
              Book appointment, consult with doctors, and manage your healthcare
              journey
            </CardDescription>
            <Button
          ...
          <form className="space-y-6" onSubmit={handleSubmit(onDoctorSubmit)}>
            ...
            <div className="space-y-2">
              ...
              <Input
                id="credentialUrl"
                type="url"
                placeholder="eg. https://example.com/my-medical-degree.pdf"
              ...
              <p className="text-sm text-muted-foreground">
                Please provide a link to a document or image that verifies your
                medical credentials.
              </p>
            </div>
